...
jQuery(document).ready(function($) {
		...
		var folder_path = 'http://localhost/sp_website/media/';
		...
		if (!($.cookie('stylesheet'))) {
			...
			if ($(".header-page-dark").length>0) {
				document.getElementById("logo").src=folder_path + "images/logo_dark_header_" + stylesheet + ".png";
			} else {
				document.getElementById("logo").src=folder_path + "images/logo_" + stylesheet + ".png";
			};
		};
